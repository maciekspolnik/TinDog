    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        if (userRepository.existsByUsername(signUpRequest.getUsername())) {
            return ResponseEntity
                    .badRequest()
                    .body(new MessageResponse("Podana nazwa uzytkownika jest juz w uzyciu!"));
        }

        if (userRepository.existsByEmail(signUpRequest.getEmail())) {
            return ResponseEntity
                    .badRequest()
                    .body(new MessageResponse("Podany email jest juz w uzyciu!"));
        }
        ...
        return ResponseEntity.ok(new MessageResponse("Rejestracja przebiegla pomyslnie!"));
    }
}
